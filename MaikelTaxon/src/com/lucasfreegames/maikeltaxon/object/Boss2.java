 ...
 * @version 1.0
 */
public abstract class Boss2 extends AnimatedSprite
{
	// ---------------------------------------------
	// VARIABLES
	// ---------------------------------------------
	...
	public Boss2(float pX, float pY, VertexBufferObjectManager vbo, Camera camera, PhysicsWorld physicsWorld)
	{
		super(pX, pY, ResourcesManager.getInstance().boss2_region, vbo);
	...
	{		
		...
		physicsWorld.registerPhysicsConnector(new PhysicsConnector(this, body, true, false)
		{
	        ...
	        public void onUpdate(float pSecondsElapsed)
	        {
				...
				if (getX() >= 6100 && isDirectionRight())
				{					
					flyingTurn();
				}
				if (getX() <= 5700 && !isDirectionRight())
				{					
					flyingTurn();
				}
	...
	public void startFlying(){
		...
		final long[] BOSS_ANIMATE = new long[] { 100,100,100,100,100};	
		animate(BOSS_ANIMATE, 0, 4, true);
